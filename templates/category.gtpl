    ...
    <div class="wrap-table">
        ...
        <nav>
            <ul class="pagination">
                ...
                {{end}}
                {{if gt (minus .Pagination.Index 2) 0}}
