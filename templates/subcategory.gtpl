...
<form action="subcategory" method="POST">
    <div class="wrap-primary">
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#Modal-Create-Subcate">Create new subcategory</button>
    </div>
    ...
    <div class="modal fade" id="Modal-Create-Subcate" tabindex="-1" role="dialog" aria-labelledby="ModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id="ModalLabel">Create new subcategory</h4>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <label for="createdsubcatename" class="control-label">Name:</label>
                        <select name="category" id="createdcategory">
                            {{range .Categories}}
                    ...
                    <div class="form-group">
                        <label for="createdsubcatename" class="control-label">Name:</label>
                        <input type="text" name="createdsubcatename" class="form-control" id="createdsubcatename">
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
